var aNPlusB = function (str, i) {
  ...
  if (aNPlusB.regExp.test(str)) {
    matches = str.match(aNPlusB.regExp)
...
var elesOfType = function (arr, type) {
...
module.exports = {
  ...
  'nth-last-child': function (ele, parent, n) {
    ...
    throw new Error(':nth-last-child(n) only accepts even, odd and formula containing positive integers, plus, minus or n as n')
  },
  ...
  'nth-of-type': function (ele, parent, n) {
    var elesOfSameType
    ...
    throw new Error(':nth-of-type(n) only accepts even, odd and formula containing positive integers, plus, minus or n as n')
  },
  'nth-last-of-type': function (ele, parent, n) {
    var elesOfSameType
    ...
    throw new Error(':nth-last-of-type(n) only accepts even, odd and formula containing positive integers, plus, minus or n as n')
  },
  'first-of-type': function (ele, parent) {
    if (!parent) {
  ...
  'last-of-type': function (ele, parent) {
    var elesOfSameType
  ...
  'only-of-type': function (ele, parent) {
    if (!parent) {
